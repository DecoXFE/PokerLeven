  ...
  loc_vars = function(self, info_queue, card)
    return {
      key = (card.ability.extra.tech_level or 0) < 5
          and 'j_ina_Kevin_Dragonfly' or 'j_ina_Kevin_Dragonfly_inf',
...
name = "Shadow_Cimmerian",
  ...
  loc_vars = function(self, info_queue, center)
    return {
      key = center.ability.extra.clone and 'j_ina_Shadow_Cimmerian_clone' or 'j_ina_Shadow_Cimmerian',
      vars = {}
    }
  end,
  rarity = 1,
...
return {
  name = "Raimon",
  list = { Mark_Evans, Nathan_Swift, Jack_Wallside, Jim_Wraith, Tod_Ironside, Steve_Grim, Paul_Peabody, Maxwell_Carson, Axel_Blaze, Kevin_Dragonfly, William_Glass, Bobby_Shearer, Erik_Eagle, Jude_Raimon, Shadow_Cimmerian },
}
